...
export default function BankingDashboardPage() {
  return <ComingSoon
    ...
    description={[
      "A unified overview of all your banking activity: balances across accounts, inflows and outflows, pending transfers, and cash-flow forecasting.",
      "Spot trends in seconds with interactive charts, drill down to individual transactions, and act on alerts in real time.",
    ]}
  />;
}
